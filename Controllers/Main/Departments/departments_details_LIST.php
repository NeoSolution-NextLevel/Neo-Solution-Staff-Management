<?php
class departments_details_LIST
{
    ...
    {
        $this->sql_search_data .= " AND id='" . $get_id . "'";
    }

    public function filter_by_name($get_name)
    {
        $this->sql_search_data .= " AND name='" . $get_name . "'";
    }

    public function filter_by_head($get_head)
    {
        $this->sql_search_data .= " AND head='" . $get_head . "'";
    }


    public function filter_by_search($get_search)
    {
        $this->sql_search_data .= " AND (name LIKE '%" . $get_search . "%' OR head LIKE '%" . $get_search . "%')";
    }
    ...
    public function get_result()
    {
        ...
        $get_sql_query = "SELECT " . $this->sql_process_data .
            " FROM departments WHERE ast='" . $this->ast_state . "'" .
