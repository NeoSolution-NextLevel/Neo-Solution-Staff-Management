...
class job_roles_LIST
{
    ...
    public function filter_by_departments($get_dept)
    {
...
if (!class_exists('job_roles_details_LIST')) {
    class job_roles_details_LIST extends job_roles_LIST {}
}
?>
