    ...
    <div class="sidebar-brand">
        <div class="brand-logo-wrap">
            <svg class="brand-logo-img" viewBox="0 0 260 80" width="140" height="44" xmlns="http://www.w3.org/2000/svg">
                <defs>
                    <radialGradient id="sbBlueSphere" cx="35%" cy="35%" r="65%">
                    ...
                    <radialGradient id="sbGreenSphere" cx="35%" cy="35%" r="65%">
                ...
                <g transform="translate(4, 2)" filter="url(#sbSphereShadow)">
                    <circle cx="22" cy="22" r="14" fill="url(#sbBlueSphere)"/>
                    <circle cx="48" cy="30" r="13" fill="url(#sbGreenSphere)"/>
                    <circle cx="23" cy="48" r="13" fill="url(#sbGreenSphere)"/>
                    <circle cx="48" cy="56" r="14" fill="url(#sbBlueSphere)"/>
                </g>
                <text x="80" y="47" font-family="-apple-system, BlinkMacSystemFont, 'Segoe UI', Impact, Arial Black, sans-serif" font-size="46" font-weight="900" letter-spacing="2" fill="url(#sbNeoGrad)">NEO</text>
